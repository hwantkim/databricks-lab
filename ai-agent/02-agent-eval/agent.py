...
# Unity Catalog UDF를 도구로 사용하기 위해 필요
...
class MCPToolWrapper(BaseTool):
    """Databricks MCP 도구를 LangChain BaseTool로 래핑"""
    ...
    def __init__(self, name: str, description: str, server_url: str, ws_client: WorkspaceClient):
        ...
        # 서버 정보를 내부적으로 저장 (Pydantic 필드가 아님)
        self._tool_data = {
...
class LangGraphResponsesAgent(ResponsesAgent):
    def __init__(
        ...
        llm_endpoint_name: str = "databricks-gemma-3-12b",
        system_prompt: Optional[str] = None,
